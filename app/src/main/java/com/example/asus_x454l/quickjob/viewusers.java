...
public class viewusers extends AppCompatActivity {
    ...
    public static final String FB_Database_Path = "user1";
        ...
        if (imguri != null) {
            ...
            ref.putFile(imguri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    UserInformationNew imageUpload = new UserInformationNew(id22,editText.getText().toString(),editText1.getText().toString(),
                            editText2.getText().toString(),taskSnapshot.getDownloadUrl().toString());

                    //Save image info in to firebase database
                    // String uploadId = databaseReference.push().getKey();
                    databaseReference.child(id22).setValue(imageUpload);
