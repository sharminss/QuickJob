...
public class ADD_JOB3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add__job3);
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //Init adapter
                adapter = new userinformationlistNew(ADD_JOB3.this, R.layout.listout4, imgList);
